...
export class Footer extends Component {
    ...
    render() {
        return <footer class="mainfooter" role="contentinfo">
                    ...
                    <div class="footer-pad">
                      ...
                      <ul class="list-unstyled">
                        <li className="ProjectsItem">
                          <a className="footer-links" href="#">Payment Center</a>
                        </li>
                        <li className="ProjectsItem">
                          <a className="footer-links" href="#">Contact Directory</a>
                        </li>
                        <li className="ProjectsItem">
                          <a className="footer-links" href="#">Forms</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div class="col-md-3 col-sm-6">
                    <div class="footer-pad">
                      ...
                      <ul class="list-unstyled">
                        ...
                        <li className="AoutItem">
                          <a className="footer-links" href="#">The Team</a>
                        </li>
                      </ul>
                    </div>
                  </div>
